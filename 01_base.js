...
//если одна из переменных строка, то сработате конкатенация - все приводится к строке => age.toString()
...
//let myEge = 2020 - 1985
//console.log(currentYear++) // вот тут вот еще выведется 2020 - попорядку - вывели старое значение, а после увеличили
...
/********9 МАССИВЫ************/
//это тип Обьектов (typeof [] - object), в которых в качестве ключей используются чиста: 1: "Mazda"
